...
// =============================================================================
// Catches runtime errors in the settings page.
// =============================================================================
...
export default function SettingsError({ error, reset }: SettingsErrorProps) {
  useEffect(() => {
    logger.error('[Settings Error]', undefined, error);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-neutral-500">
          Something went wrong while loading your settings. Your changes may not
          have been saved. Please try again.
        </p>
        {error.digest && (
