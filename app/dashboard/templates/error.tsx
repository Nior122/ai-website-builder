...
// =============================================================================
// Catches runtime errors in the template gallery page.
// =============================================================================
...
export default function TemplatesError({ error, reset }: TemplatesErrorProps) {
  useEffect(() => {
    logger.error('[Templates Error]', undefined, error);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-neutral-500">
          Something went wrong while loading the template gallery. Please try
          again.
        </p>
        {error.digest && (
