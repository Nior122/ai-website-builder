...
// =============================================================================
// Catches runtime errors in the admin dashboard.
// =============================================================================
...
export default function AdminError({ error, reset }: AdminErrorProps) {
  useEffect(() => {
    logger.error('[Admin Error]', undefined, error);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-neutral-500">
          Something went wrong while loading admin data. If this persists,
          check your admin permissions or contact support.
        </p>
        {error.digest && (
