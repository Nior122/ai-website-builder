...
// =============================================================================
// Catches runtime errors in the AI generation page.
// =============================================================================
...
export default function GenerateError({ error, reset }: GenerateErrorProps) {
  useEffect(() => {
    logger.error('[Generate Error]', undefined, error);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mb-6 text-sm text-neutral-500">
          Something went wrong with the AI generation. No credits were used.
          You can try again with a new request.
        </p>
        {error.digest && (
